...
all_classes = [i for i in range(1, 81)]
background = [0]
fold_0 = [i for i in range(1, 81, 4)]
fold_1 = [i for i in range(2, 81, 4)]
fold_2 = [i for i in range(3, 81, 4)]
fold_3 = [i for i in range(4, 81, 4)]

image_path = 'E:/DataSet/Nature/COCO/resized_image/'
seg_label_path = 'E:/DataSet/Nature/COCO/label_classify/'
contour_label_path = 'E:/DataSet/Nature/COCO/gt_contour/'
new_label_path = 'E:/DataSet/Nature/COCO/new_label/'
canny_path = 'E:/DataSet/Nature/COCO/canny/'
...
def get_oneshot_batch(fold, batch_size, train=True):
    ...
    for i in range(batch_size):
        ...
        support_image = support_image[:, :, ::-1]  # bgr to rgb
